...
{  
	@Query(value="SELECT * FROM chat WHERE chat.receiver_user_id = ?1 GROUP BY chat.sender_user_id , chat.sender_user_id order by chat.id_chat desc",nativeQuery=true)
