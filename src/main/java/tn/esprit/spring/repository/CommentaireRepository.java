...
{ 
	@Query(value=" select commentaire.id_comm , commentaire.description , commentaire.date_commentaire , commentaire.comm_sujet_id_sujet , commentaire.comm_user_id_user , count(react.react_comm_id_comm) as nbr from commentaire LEFT JOIN react on commentaire.id_comm = react.react_comm_id_comm GROUP by commentaire.id_comm Order by nbr DESC ",nativeQuery=true )
